...
#     def add_subscription(self, user, package, pickup_days):
#         new_subscription = Node({"user": user, "package": package, "pickup_days": pickup_days})
#         if not self.head:
...
# subscription_system.add_subscription("User1", "Standard", ["Monday", "Wednesday", "Friday"])
# subscription_system.add_subscription("User2", "Premium", ["Tuesday", "Thursday"])
# subscription_system.add_subscription("User3", "VIP", ["Monday", "Wednesday", "Friday", "Saturday"])
